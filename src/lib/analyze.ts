...
function findEquipmentKeywords(description: string): string[] {
  const keywords: Record<string, string[]> = {
    ...
    "resistance band": ["resistance band","exercise band","resistance bands"],
    bench: ["bench","weight bench","flat bench","incline bench","decline bench","adjustable bench"],
    "cable machine": ["cable","cable machine","pulley","cable crossover","weight stack","cable station"],
    ...
    "rowing machine": ["rowing machine","rower","ergometer","indoor rower","erg"],
    "pull up bar": ["pull up bar","pull-up bar","chin up bar","pullup bar"],
    "yoga mat": ["yoga mat","exercise mat","yoga"],
    "exercise bike": ["stationary bike","exercise bike","spin bike","cycle","stationary bicycle"],
    treadmill: ["treadmill","tread mill","running machine"],
    elliptical: ["elliptical","cross trainer","elliptical trainer"],
    "chest press machine": ["chest press machine","chest press","pectoral machine","pec fly machine","pec deck","seated chest press","plate loaded chest press"],
    "leg extension machine": ["leg extension machine","leg extension","leg extension curl"],
    "leg curl machine": ["leg curl machine","leg curl","hamstring curl machine"],
    "shoulder press machine": ["shoulder press machine","shoulder press","overhead press machine","seated shoulder press machine"],
    "lat pulldown machine": ["lat pulldown machine","lat pulldown","lat pull down","lat machine","pulldown machine"],
  };
